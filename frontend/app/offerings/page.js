  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2">Temple Offerings</h1>
          <p className="text-gray-600">Sacred offerings for divine blessings</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {offerings.map((offering) => (
            <div key={offering.id} className="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">{offering.name}</h3>
