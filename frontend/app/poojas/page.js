    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-stone-600">Reserve rituals and poojas for divine blessings</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <h2 className="text-2xl font-bold text-stone-800 mb-6">Pooja Options</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {poojaOptions.map((pooja) => (
                <div
                  ...
                  {/* Pooja Image */}
                  <div className="relative h-48 bg-linear-to-br from-teal-300 to-teal-500 flex items-center justify-center">
                    <span className="text-white text-sm">Pooja Image</span>
                    <div className="absolute top-4 right-4 bg-teal-600 text-white px-3 py-1 rounded-lg font-bold">
                      ₹ {pooja.price}
                    </div>
                  </div>
                  ...
                  {/* Pooja Details */}
                  <div className="p-4">
                    <h3 className="text-xl font-bold text-stone-800 mb-2">{pooja.name}</h3>
