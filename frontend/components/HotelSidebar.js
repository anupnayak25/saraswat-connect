...
export default function HotelSidebar({ activePage }) {
  ...
  const menuItems = [
    { name: "Dashboard", href: "/hotel", icon: "📊" },
    { name: "Room Bookings", href: "/hotel/bookings", icon: "🛏️" },
    { name: "Calendar", href: "/hotel/calendar", icon: "📅" },
  ];

  return (
    <div className="w-64 bg-gray-900 min-h-screen text-white flex flex-col">
      <div className="p-6">
        <h1 className="text-2xl font-bold">Hotel Panel</h1>
